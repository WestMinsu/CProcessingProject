...
CP_Image Main_title_background;
//----------------------------------------------------------------
...
void MainMenuInit(void)
{
	...
	//Main_Title_Music = CP_Sound_Load("Assets/MainMenu/main_ost.mp3"); 

	button_start = CP_Image_Load("Assets/MainMenu/start.png");
	button_exit = CP_Image_Load("Assets/MainMenu/exit.png");
	Main_title_background = CP_Image_Load("Assets/MainMenu/title_background.png");
...
void MainMenuUpdate(void)
{
	...
	//이미지 draw ---------------------------------------------
	CP_Image_Draw(Main_title_background, CP_System_GetWindowWidth() / 2.0f, CP_System_GetWindowHeight() / 2.0f, CP_System_GetWindowWidth() / 1.0f, CP_System_GetWindowHeight() / 1.0f, 255); // 메인 배경
...
void MainMenuExit(void)
{
	...
	CP_Image_Free(&Main_title_background);
